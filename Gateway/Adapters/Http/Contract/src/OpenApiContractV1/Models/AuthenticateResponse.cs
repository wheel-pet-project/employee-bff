...
namespace OpenApiContractV1.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthenticateResponse : IEquatable<AuthenticateResponse>
    {
        /// <summary>
        /// Токен доступа.
        /// </summary>
        ...
        /// </summary>
        /// <value>Токен для обновления доступа.</value>
        /* <example>eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c</example> */
        [Required]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AuthenticateResponse)obj);
        }

        /// <summary>
        /// Returns true if AuthenticateResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AuthenticateResponse to be compared</param>
        /// <returns>Boolean</returns>
